            ...
            <div className="about__content">
                ...
                <div className='about__intro-wrapper'>
                    ...
                    <p className="about__paragraph">
                        I'm a software developer born and raised in Toronto. Recently, I received my second degree in computer science with honours from Laurentian University and completed BrainStation's web development program. For the last 4 years while in school,  and post graduation, I have also worked as a web developer creating and maintaining elegant and robust websites for startups. Furthermore, I have worked on two different indie game projects in a small team as our resident programmer, sprite artist, designer, and audio engineer.
                    </p>
                </div>
